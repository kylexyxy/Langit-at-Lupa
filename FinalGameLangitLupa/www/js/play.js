playGame={
    ...
    labelScore = game.add.text(0, 50, 'Score:0', {font: '30px serif', fill: 'white'}); 
 
    labelhi = game.add.text(0, 10, "Highest Score: " +getScore(),{font: '30px serif', fill: 'white'}); 

    buttonjump = game.add.button(570, 530, 'buttonjump');  
    ...
    buttonleft = game.add.button(350, 530, 'buttonhorizontal');
    buttonleft.events.onInputOver.add(function(){left=true;});
    buttonleft.events.onInputOut.add(function(){left=false;});
    buttonleft.events.onInputDown.add(function(){left=true;});
    buttonleft.events.onInputUp.add(function(){left=false;});

    buttonright = game.add.button(420, 530, 'buttonhorizontals');
    ...
    pause_label = game.add.image(20, 100, 'pause');
